...
@Controller
@RequestMapping("/storefrontTrainingPage")
public class StorefrontTrainingPageController extends AbstractPageController {

    private static final String TEMPLATE_PAGE = "storefrontTrainingPage";
